...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('turbolinks:load', function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".nested-fields").length === 1) jquery__WEBPACK_IMPORTED_MODULE_0___default()(".remove-sales-rep-link").remove();

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sales-rep-option").is(":checked")) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".all_suppliers").slideDown("slow");
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#sales-rep-option").on("click", function (e) {
    e.target.checked ? jquery__WEBPACK_IMPORTED_MODULE_0___default()(".all_suppliers").slideDown("slow") : jquery__WEBPACK_IMPORTED_MODULE_0___default()(".all_suppliers").slideUp("slow");
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.search-prod-cat').select2();
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.custom-file-input').change(function (e) {
    var fileName = e.target.files[0].name;
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.custom-file-label').html(fileName.substr(0, 20));
  });

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()("#product_published").is(":checked")) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".qr-container").slideDown("slow");
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#product_published").change(function (e) {
    if (e.target.checked) jquery__WEBPACK_IMPORTED_MODULE_0___default()(".qr-container").slideDown("slow");else jquery__WEBPACK_IMPORTED_MODULE_0___default()(".qr-container").slideUp("slow");
  });
});
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nError: ENOENT: no such file or directory, open '/Users/arkhitech/work/cefiles-prod/node_modules/webpack/buildin/module.js'");

/***/ })

/******/ });
//# sourceMappingURL=admin-a8470c92b7dff735c34e.js.map